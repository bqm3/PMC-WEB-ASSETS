...
import { IChinhanh, IConnguoi, IDonvi, IGroupPolicy, INhompb, INhomts, IPhongbanda, IPolicy, ITaisan } from 'src/types/taisan';

const STORAGE_KEY = 'accessToken';

export function useGetCalv() {
  const accessToken = localStorage.getItem(STORAGE_KEY);
  const URL = 'http://localhost:8888/api/ent_calv/';
...
export function useGetCalvDetail(id: string) {
  const accessToken = localStorage.getItem(STORAGE_KEY);
  const URL = `http://localhost:8888/api/ent_calv/${id}`;
  const fetCher = (url: string) =>
    fetch(url, {
      method: 'get',
      headers: {
...
export function useGetToanha() {
  const accessToken = localStorage.getItem(STORAGE_KEY);
  const URL = 'http://localhost:8888/api/ent_toanha/';
  const fetCher = (url: string) =>
    fetch(url, {
      method: 'get',
      headers: {
...
export function useGetTang() {
  const accessToken = localStorage.getItem(STORAGE_KEY);
  const URL = 'http://localhost:8888/api/ent_tang/';
  const fetCher = (url: string) =>
    fetch(url, {
      method: 'get',
      headers: {
...
export function useGetKhoiCV() {
  const URL = `http://localhost:8888/api/ent_khoicv`;
  const fetCher = (url: string) =>
    fetch(url, {
      method: 'get',
      headers: {
...
export function useGetChucvu() {
  const accessToken = localStorage.getItem(STORAGE_KEY);
  const URL = `http://localhost:8888/api/ent_chucvu`;
  const fetCher = (url: string) =>
    fetch(url, {
      method: 'get',
      headers: {
...
export function useGetKhuVuc() {
  const accessToken = localStorage.getItem(STORAGE_KEY);
  const URL = 'http://localhost:8888/api/ent_khuvuc/filter';
  const fetCher = (url: string) =>
    fetch(url, {
      method: 'post',
      headers: {
...
export function useGetDuan() {
  const accessToken = localStorage.getItem(STORAGE_KEY);
  const URL = 'http://localhost:8888/api/ent_duan/';
  const fetCher = (url: string) =>
    fetch(url, {
      method: 'get',
      headers: {
...
export function useGetDuanWeb() {
  const accessToken = localStorage.getItem(STORAGE_KEY);
  const URL = 'http://localhost:8888/api/ent_duan/thong-tin-du-an';
  const fetCher = (url: string) =>
    fetch(url, {
      method: 'get',
      headers: {
...
export function useGetGiamsat() {
  const accessToken = localStorage.getItem(STORAGE_KEY);
  const URL = 'http://localhost:8888/api/ent_giamsat/';
  const fetCher = (url: string) =>
    fetch(url, {
      method: 'get',
      headers: {
...
export function useGetGiamsatDetail(id: string) {
  const accessToken = localStorage.getItem(STORAGE_KEY);
  const URL = `http://localhost:8888/api/ent_giamsat/${id}`;
  const fetCher = (url: string) =>
    fetch(url, {
      method: 'get',
      headers: {
...
export function useGetDuanDetail(id: string) {
  const accessToken = localStorage.getItem(STORAGE_KEY);
  const URL = `http://localhost:8888/api/ent_duan/${id}`;
  const fetCher = (url: string) =>
    fetch(url, {
      method: 'get',
      headers: {
...
export function useGetToanhaDetail(id: string) {
  const accessToken = localStorage.getItem(STORAGE_KEY);
  const URL = `http://localhost:8888/api/ent_toanha/${id}`;
  const fetCher = (url: string) =>
    fetch(url, {
      method: 'get',
      headers: {
...
export function useGetKhuVucDetail(id: string) {
  const accessToken = localStorage.getItem(STORAGE_KEY);
  const URL = `http://localhost:8888/api/ent_khuvuc/${id}`;
  const fetCher = (url: string) =>
    fetch(url, {
      method: 'get',
      headers: {
...
export function useGetHangMuc() {
  const accessToken = localStorage.getItem(STORAGE_KEY);
  const URL = 'http://localhost:8888/api/ent_hangmuc/';
  const fetCher = (url: string) =>
    fetch(url, {
      method: 'get',
      headers: {
...
export function useGetUsers() {
  const accessToken = localStorage.getItem(STORAGE_KEY);
  const URL = 'http://localhost:8888/api/ent_user/get-online';
  const fetCher = (url: string) =>
    fetch(url, {
      method: 'get',
      headers: {
...
export function useGetHangMucDetail(id: string) {
  const accessToken = localStorage.getItem(STORAGE_KEY);
  const URL = `http://localhost:8888/api/ent_hangmuc/${id}`;
  const fetCher = (url: string) =>
    fetch(url, {
      method: 'get',
      headers: {
...
export function useGetChecklist(pag: any) {
  const accessToken = localStorage.getItem(STORAGE_KEY);
  const URL = `http://localhost:8888/api/ent_checklist/?page=${
    Number(pag?.page) + 1
  }&limit=${pag?.limit}`;
  const fetCher = (url: string) =>
    fetch(url, {
...
export function useGetTb_Checklist(pag: any) {
  const accessToken = localStorage.getItem(STORAGE_KEY);
  const URL = `http://localhost:8888/api/tb_checklistc/?page=${Number(
    pag?.page
  )}&limit=${pag?.limit}`;
  const fetCher = (url: string) =>
    fetch(url, {
...
export function useGetTb_ChecklistDetail(id: any) {
  const accessToken = localStorage.getItem(STORAGE_KEY);
  const URL = `http://localhost:8888/api/tb_checklistc/ca/${id}`;
  const fetCher = (url: string) =>
    fetch(url, {
      method: 'get',
      headers: {
...
export function useGetChecklistWeb() {
  const accessToken = localStorage.getItem(STORAGE_KEY);
  const URL = `http://localhost:8888/api/ent_checklist/web`;
  const fetCher = (url: string) =>
    fetch(url, {
      method: 'get',
      headers: {
...
export function useGetChecklistDetail(id: string) {
  const accessToken = localStorage.getItem(STORAGE_KEY);
  const URL = `http://localhost:8888/api/ent_checklist/${id}`;
  const fetCher = (url: string) =>
    fetch(url, {
      method: 'get',
      headers: {
...
export function useGetUserDetail(id: string) {
  const accessToken = localStorage.getItem(STORAGE_KEY);
  const URL = `http://localhost:8888/api/ent_user/${id}`;
  const fetCher = (url: string) =>
    fetch(url, {
      method: 'get',
      headers: {
...
export function useGetKhuvucByToanha(id?: string) {
  const accessToken = localStorage.getItem(STORAGE_KEY);
  const URL = `http://localhost:8888/api/ent_toanha/khuvuc/${id}`;
  const fetCher = (url: string) =>
    fetch(url, {
      method: 'get',
      headers: {
...
export function useGetGroupPolicy() {
  const accessToken = localStorage.getItem(STORAGE_KEY);
  const URL = 'http://localhost:8888/api/ent_grouppolicy/all';
  const fetCher = (url: string) =>
    fetch(url, {
      method: 'get',
      headers: {
...
export function useGetPolicy() {
  const accessToken = localStorage.getItem(STORAGE_KEY);
  const URL = 'http://localhost:8888/api/ent_policy/all';
  const fetCher = (url: string) =>
    fetch(url, {
      method: 'get',
      headers: {
...
export function useGetConNguoi() {
  const accessToken = localStorage.getItem(STORAGE_KEY);
  const URL = 'http://localhost:8888/api/ent_connguoi/all';
  const fetCher = (url: string) =>
    fetch(url, {
      method: 'get',
      headers: {
...
export function useGetNhomPb() {
  const accessToken = localStorage.getItem(STORAGE_KEY);
  const URL = 'http://localhost:8888/api/ent_nhompb/all';
  const fetCher = (url: string) =>
    fetch(url, {
      method: 'get',
      headers: {
...
export function useGetChinhanh() {
  const accessToken = localStorage.getItem(STORAGE_KEY);
  const URL = 'http://localhost:8888/api/ent_chinhanh/all';
  const fetCher = (url: string) =>
    fetch(url, {
      method: 'get',
      headers: {
...
export function useGetNhomts() {
  const accessToken = localStorage.getItem(STORAGE_KEY);
  const URL = 'http://localhost:8888/api/ent_nhomts/all';
  const fetCher = (url: string) =>
    fetch(url, {
      method: 'get',
      headers: {
...
export function useGetTaisan() {
  const accessToken = localStorage.getItem(STORAGE_KEY);
  const URL = 'http://localhost:8888/api/ent_taisan/all';
  const fetCher = (url: string) =>
    fetch(url, {
      method: 'get',
      headers: {
...
export function useGetDonvi() {
  const accessToken = localStorage.getItem(STORAGE_KEY);
  const URL = 'http://localhost:8888/api/ent_donvi/all';
  const fetCher = (url: string) =>
    fetch(url, {
      method: 'get',
      headers: {
...
export function useGetPhongBanDa() {
  const accessToken = localStorage.getItem(STORAGE_KEY);
  const URL = 'http://localhost:8888/api/ent_phongbanda/all';
  const fetCher = (url: string) =>
    fetch(url, {
      method: 'get',
      headers: {
