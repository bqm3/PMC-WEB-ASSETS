...
//
import PhieuNXTableRow from '../phieuncc-table-row';
import PhieuNXTableToolbar from '../phieuncc-table-toolbar';
import PhieuNXTableFiltersResult from '../phieuncc-table-filters-result';
...
export default function PhieuNXListView() {
  ...
  const handleDeleteRow = useCallback(
    async (id: string) => {
      await axios
        .put(`${PATH_URL}/tb_phieuncc/delete/${id}`, [], {
          headers: {
  ...
  const handleCloseRow = useCallback(
    async (id: string) => {
      await axios
        .put(`${PATH_URL}/tb_phieuncc/close-fast/${id}`, [], {
          headers: {
            Accept: 'application/json',
            Authorization: `Bearer ${accessToken}`,
          },
  ...
  const handleUpdate = useCallback(
    async (id: string) => {
      await axios
        .put(`${PATH_URL}/tb_phieuncc/update/${id}`, dataSelect, {
          headers: {
            Accept: 'application/json',
            Authorization: `Bearer ${accessToken}`,
          },
